 ...
 * @Date 2016/6/18.
 */
public class CheckSexDialog extends PopupWindow {
    public Context context;
    private View view;
    private OnGenderSelectListener onGenderSelectListener;

    public CheckSexDialog(Context context, OnGenderSelectListener listener) {
        super(context);
        this.context = context;
        this.onGenderSelectListener = listener;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view = inflater.inflate(R.layout.check_sex_dialog, null);
        ...
        Button bt_man = (Button) view.findViewById(R.id.sex_man);
        bt_man.setOnClickListener(clicklistener);
        Button bt_woman = (Button) view.findViewById(R.id.sex_woman);
        bt_woman.setOnClickListener(clicklistener);
        Button bt_secert = (Button) view.findViewById(R.id.sex_mimi);
