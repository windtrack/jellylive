package com.oo58.jelly.view.refreshview;
...
import com.oo58.jelly.view.refreshview.pulllableview.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	public void refreshFinish(int refreshResult)
	{
		...
		if(!tellState && refreshResult==SUCCEED){
			changeState(DONE);
			hide();
			return ;
		}
	...
	public void setTellLoadState(boolean flag){
		tellState = flag ;
	}
